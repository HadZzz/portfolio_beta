  ...
  return (
    <div id='hero' className='flex items-center justify-center flex-col py-28'>
      <div className=' text-center'>
        <h1 className='text-2xl md:text-4xl mb-1 md:mb-3 text-indigo-600 font-semibold font-japanese dark:text-indigo-500'>
          Hi, Iam Hadzi Pamuji
        </h1>
        <p className='text-md md:text-xl max-w-md mb-3 text-gray-600 dark:text-gray-300'>
          Saya seorang Front-End Engineer pemula Saya memiliki dasar dalam HTML,
          CSS, JavaScript, dan React.js,
        </p>
        <a
          href='#works'
